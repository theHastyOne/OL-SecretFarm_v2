...
async function handleRequest(request, env) {
  ...
  if (url.pathname.startsWith('/cyberneticostrich/exploration/flights/securityprotocol/2024/special-operations/encrypted-flight-data-center/access-authorized/')){
